        ...
        if (projectSnap.connectionState == ConnectionState.none || projectSnap.data == null) {
          ...
          return favSize == 0
            ...
            child: Align(
                ...
                child: Container(
                  child: Center(child: Text('No Favorites Found..!',style: TextStyle(color: Colors.black),)),
                  height: MediaQuery.of(context).size.height - 150 - kToolbarHeight - 24,
                )),
          )
              : Padding(
                          ...
                          child: Row(
                            children: <Widget>[
                              ...
                              FutureBuilder(
                                ...
                                future: db.getFav(projectSnap.data[i].id.toString()),
                              ),
                            ],
                          )),
                    ),
    ...
    return Card(
      ...
      child: InkWell(
        onTap: () async {
          ...
          audios.clear();
          await updateQueue(start: true, ind: index, choiceIndex: 1,context: context);
        },
        child: Padding(
            padding: const EdgeInsets.all(5.0),
            child: Row(
